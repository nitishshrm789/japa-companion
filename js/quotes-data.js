/**
 * Inspirational readings for enthusiastic, heartfelt japa.
 * Short traditional teachings for personal sadhana inspiration.
 */
window.JapaQuotes = {
  intro: {
    title: "Chant with your whole heart",
    body: "The Hare Krishna maha-mantra is not a mechanical duty. It is the holy name of the Lord — non-different from Krishna Himself. Read a little, remember the mood of the acaryas, then chant with love, attention, and enthusiasm.",
  },
  ...
  mantra: {
    ...
    note: "These sixteen names destroy the darkness of Kali-yuga when chanted with faith.",
  },
  ...
  sections: [
    {
      ...
      quotes: [
        {
          text: "Chant Hare Krishna and be happy. This is not a slogan only — it is the simplest and most sublime process for this age.",
          source: "Srila A.C. Bhaktivedanta Swami Prabhupada",
        },
        {
          text: "The holy name of Krishna is Krishna Himself. If you chant attentively, you are associating with Krishna. Do not chant like a parrot — chant with feeling.",
          source: "Srila Prabhupada — on attentive japa",
        },
        {
          text: "Even if you cannot follow all rules and regulations perfectly, if you sincerely chant the Hare Krishna maha-mantra, Krishna will help you from within.",
          source: "Srila Prabhupada — on sincerity in chanting",
        },
        {
          text: "Quality is more important than quantity. Better to chant carefully with attention than to rush through many rounds with a wandering mind.",
          source: "Srila Prabhupada — quality of japa",
        },
        {
          text: "Rise early, chant your rounds, and remember Krishna throughout the day. This is the essence of the Krishna consciousness process.",
          source: "Srila Prabhupada — daily sadhana",
        },
        {
  ...
  practice: {
    heading: "Before you start your next round",
    points: [
      "Sit calmly. Offer a short prayer: “O Hare, O Krishna, please engage me in Your service.”",
      "Hear each syllable. If the mind wanders, gently bring it back to the sound of the Name.",
      "Chant with enthusiasm (utsaha), patience (dhairya), and humility (trinad api sunichena).",
      "Remember: you are calling out to Radha and Krishna with love — not finishing a task.",
      "After each round, thank the Lord silently, then begin the next with fresh heart.",
    ],
  },
};
